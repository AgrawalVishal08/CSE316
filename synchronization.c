...
things_table[0][0] = 1; //student1 has pen things_table[1][1] = 2; //student2 has paper things_table[2][2] = 3; //student3 has question_paper
printf("\t\t\t\t\t --by Vishal Agrawal,EE035,11706065\n"); //printf("\t\t\t\t\t\t\t\t\n");
